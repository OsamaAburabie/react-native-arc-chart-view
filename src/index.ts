...
import { ChangeEventPayload, ReactNativeArcChartViewProps } from './ReactNativeArcChartView.types';
...
const emitter = new EventEmitter(ReactNativeArcChartViewModule ?? NativeModulesProxy.ReactNativeArcChartView);

export function addChangeListener(listener: (event: ChangeEventPayload) => void): Subscription {
  return emitter.addListener<ChangeEventPayload>('onChange', listener);
}

export { ReactNativeArcChartView, ReactNativeArcChartViewProps, ChangeEventPayload };
